...
const CreateService = () => {
    ...
    return (
        <main >
            <section id='admin' className='px-5'> 
              <div className="container py-1  max-w-5xl pt-2 text-center mx-auto">
                    <h1 className='text-center text-2xl font-heading font-bold text-black'>{t("create_service")}</h1>
                    <div className="mt-8 form_container text-left">
                                ...
                                <div>
                                    ...
                                    <div className="image_upload_container md:p-5 md:border-2 bg-transparent border-dashed rounded-sm md:flex items-center justify-center gap-2">
                                     ...
                                     <input
                                            ...
                                            type="file"
                                            className={`file-input file:bg-green ${loading ? "md:w-4/6" : 'md:w-4/5'} w-full`} 
                                     />
                                        <button
                                            disabled={loading || imageFile.length === 0}
                                            onClick={handleImageUpload}
                                            type='button' className={`w-full text-black text-sm py-2 border-2 border-green-600 rounded-md mt-2 uppercase font-heading  ${loading ? "md:w-2/6" : 'md:w-1/5'} md:h-[3rem] md:mt-0 duration-500 hover:shadow-lg disabled:border-gray-500 disabled:text-gray-500`}>
                                            {
                                    ...
                                    <div>
                                        ...
                                        <div className="post_btn mt-7">
                                            <button
                                                ...
                                                type='submit'
                                                className="w-full bg-red text-xl tracking-wider font-heading rounded-md hover:opacity-30 disabled:opacity-40 duration-300 text-white p-3">
                                                {
                                                    formSubmitLoading ? t('creating') : t("create_service")
                                                }
                                            </button>
                                        </div>
                                    </div>
